...
#配列準備
array=($namespace_grafana $grafana $install_prometheus $prom_rbac $prometheus $prom_svc $servicemonitor_prometheus $servicemonitor_nginx $servicemonitor_php_fpm)
